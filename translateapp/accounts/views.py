...
def dashboard(request):
    ...
    my_active_jobs =user.account.active_jobs()
    my_completed_jobs = user.account.completed_jobs()
    my_thread_users = Message.get_thread_users(user)
    my_threads = Message.get_threads_for(user)
